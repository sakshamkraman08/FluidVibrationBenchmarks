...
if !isdir("../FluidVibrationBenchmarks/images")
    mkdir("../FluidVibrationBenchmarks/images")
end
savefig("../FluidVibrationBenchmarks/images/string_simulation.png")

println("String simulation completed! Plot saved to ../FluidVibrationBenchmarks/images/string_simulation.png")
