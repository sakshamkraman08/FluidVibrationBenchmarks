...
savefig("../FluidVibrationBenchmarks/images/beam_modes.png")

println("Beam vibration simulation completed! Plot saved to ../FluidVibrationBenchmarks/images/beam_modes.png")
